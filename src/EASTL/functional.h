...
namespace eastl
{
	...
	struct equal_to_2 : public binary_function<T, U, bool>
	{
		...
		template <typename T_ = T, typename U_ = U, typename = eastl::enable_if_t<!eastl::is_same<eastl::remove_const_t<T_>, eastl::remove_const_t<U_>>::value>>
	...
	template <typename T>
	struct hash : Internal::EnableHashIf<T, is_enum<T>::value> {};
